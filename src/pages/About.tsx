                    ...
                    <Col md={6}>
                        ...
                        <div className="text-lg text-gray-700 leading-relaxed">
                            <p className="mb-4">
                                ...
                                every student can <strong>"Speak STOP Fluently and Flawlessly For Life!"</strong>
                            ...
                            <p className="mb-4">
                                ...
                                and <strong>Seniors</strong>. We don't just teach the mechanics of driving; we focus
                                on defensive techniques and "survival" skills needed for today's busy roads.
                            </p>
                            ...
                            <div className="bg-slate-800 text-white p-5 rounded mt-5">
                                ...
                                <p className="italic mb-0">
                                    "Whether you are a nervous beginner or looking for a safety evaluation,
                                    we provide door-to-door, valet-style service 7 days a week to ensure
                                    you are road-ready and confident."
                                </p>
